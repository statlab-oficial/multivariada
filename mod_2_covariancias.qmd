...
Esse resultado recupera, no nível matricial, o limite apresentado na @eq-limite-covariancia.
...
Se $\boldsymbol{\Sigma}_{YY}\succ\mathbf0$, o complemento de Schur
...
é a menor matriz de covariâncias residuais, segundo a ordem de Loewner, obtida ao aproximar linearmente $\boldsymbol{\mathsf X}_c$ por $\mathbf L\boldsymbol{\mathsf Y}_c$.
...
e, para qualquer $\mathbf L\in\mathbb R^{p\times q}$,
...
com $\boldsymbol{\mathsf X}\in\mathbb R^p$ e $\boldsymbol{\mathsf Y}\in\mathbb R^q$ de médias $\boldsymbol{\mu}_X$ e $\boldsymbol{\mu}_Y$, respectivamente.
:::
...
Se $\boldsymbol{\Sigma}\succ\mathbf0$ e $c>0$, considere o elipsoide
