...
Uma estatística suficiente preserva, segundo o modelo adotado, a informação da amostra sobre o parâmetro no sentido de que a distribuição condicional da amostra, dada essa estatística, não depende do parâmetro [@casella2002inference].
...
e, por @prp-transformacao-afim-covariancia, a matriz de covariâncias transformada é
