...
- $\boldsymbol{\mathsf T}$ representa a matriz total de somas de quadrados e produtos cruzados (SQPC) como estatística aleatória, e $\mathbf T$ sua realização observada, definida na @def-matriz-sscp-total;
...
A convenção $\mathbf T$ para a matriz SQPC observada mantém a notação estabelecida na @def-matriz-sscp-total.
:::
