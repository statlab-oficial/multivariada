...
\right).
$$ {#eq-distribuicao-media-amostral-transformada} A distribuição transformada pode ser singular quando
...
-   a geometria e a escala das colunas da matriz de delineamento, representadas pelos elementos de $(\mathbf Z^\top\mathbf Z)^{-1}$;
...
\boldsymbol{\mu}_0
\right).
$$ {#eq-nao-centralidade-vetor-medias} Defina
...
\sim
\chi_h^2.
$$ {#eq-distribuicao-hipotese-linear-media-cov-conhecida} Sob uma alternativa fixa,
