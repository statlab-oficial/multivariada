...
### Aprofundamento: contagem de parâmetros e identificação
...
### Aprofundamento: critérios específicos de rotação {#sec-fatorial-criterios-rotacao}
...
### Aprofundamento: adequação da matriz de correlações à Análise Fatorial {#sec-fatorial-adequacao}

::: {.callout-note appearance="simple" icon=false}
## Leitura de aprofundamento

A formulação do modelo fatorial não depende dos procedimentos apresentados nesta seção. Na aplicação da Análise Fatorial Exploratória, entretanto, medidas baseadas nas correlações simples e parciais podem auxiliar a avaliar se a matriz de correlações apresenta uma estrutura favorável à representação por fatores comuns.
:::
...
## Dimensão do modelo fatorial {#sec-fatorial-escolha-fatores}
...
### Aprofundamento: critérios para escolha do número de fatores
...
## Ajuste amostral, matriz reproduzida e resíduos
...
Esses métodos partem de critérios distintos e não devem ser interpretados como procedimentos equivalentes. Para a formulação básica, importa reconhecer qual estrutura cada método utiliza e qual discrepância procura reduzir. Os desenvolvimentos matemáticos dos métodos baseados em matriz reduzida e mínimos resíduos são apresentados a seguir como aprofundamento. A máxima verossimilhança será retomada após a formulação do modelo fatorial normal.

### Aprofundamento: fatores principais e mínimos resíduos
...
### Aprofundamento: estimação por máxima verossimilhança e ajuste global
...
A formulação normal fornece uma interpretação probabilística desse problema por meio da distribuição condicional dos fatores.

### Aprofundamento: distribuição condicional dos fatores e escore por regressão
...
### Aprofundamento: diferentes métodos de escores fatoriais
