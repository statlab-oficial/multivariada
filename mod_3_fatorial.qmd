...
Em uma solução com dois fatores, uma transformação ortogonal pode ser visualizada como uma rotação dos eixos por determinado ângulo $\theta$. Esse ângulo não é fixado previamente pelo método: a orientação resulta do critério adotado. Os eixos permanecem perpendiculares entre si, formando $90^\circ$. Com mais de dois fatores, uma transformação ortogonal não é descrita, em geral, por um único ângulo.
...
## Avaliação da adequação da matriz de correlações à Análise Fatorial
