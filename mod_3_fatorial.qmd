...
Para uma análise baseada em covariâncias, defina

$$
\mathbf E_{\mathrm{fat}}
=
\mathbf S
-
\widehat{\boldsymbol{\Sigma}}_{\mathrm{fat}}.
$$ {#eq-residuos-covariancias-fatorial}

Para uma análise baseada em correlações,

$$
\mathbf E_{\mathrm{fat},R}
=
\mathbf R
-
\widehat{\boldsymbol{\mathcal R}}_{\mathrm{fat}}.
...
Os elementos fora da diagonal dessas matrizes representam covariâncias ou correlações que não foram reproduzidas pela estrutura comum estimada.
...
=
\mathbf A
\boldsymbol{\Lambda}_{\mathrm{ACP}}
\mathbf A^{\top},
$$

em que os autovetores definem direções principais e os autovalores representam as variâncias das componentes.
...
| Formulação | $\boldsymbol{\Sigma}=\mathbf A\boldsymbol{\Lambda}_{\mathrm{ACP}}\mathbf A^\top$ | $\boldsymbol{\Sigma}=\boldsymbol{\Lambda}\boldsymbol{\Lambda}^\top+\boldsymbol{\Psi}$ |
