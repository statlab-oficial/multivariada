...
Na @sec-agrupamentos, o problema muda para a formação de grupos de observações. A Análise de Agrupamentos será formulada a partir de medidas de proximidade e de critérios que definem a semelhança entre observações e grupos.