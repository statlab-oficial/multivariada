...
A formulação utiliza a matriz de covariâncias populacional definida na @def-matriz-covariancias-populacional e a noção de posto da @def-posto-matriz. A normalidade multivariada não é necessária para a estrutura de segunda ordem do modelo e será introduzida apenas na formulação probabilística. Depois de definido o modelo, são examinadas sua identificação, estimação, rotação, formulação amostral e construção dos escores fatoriais.
