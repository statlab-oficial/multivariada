...
Um **sistema linear** de $n$ equações e $p$ incógnitas pode ser escrito na forma matricial
...
A matriz $\mathbf A$ é denominada **matriz dos coeficientes**, $\mathbf x$ é o **vetor de incógnitas** e $\mathbf b$ é o **vetor de termos independentes**.

Uma **solução** do sistema é qualquer vetor $\mathbf x\in\mathbb R^p$ que satisfaz a igualdade
...
O sistema linear possui uma forma particular importante quando o vetor de termos independentes é o vetor nulo.
