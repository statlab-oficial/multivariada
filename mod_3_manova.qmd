...
Essa comparação conduz a um problema de autovalores generalizados. Suas raízes características são agregadas pelos critérios de Wilks, Pillai, Hotelling--Lawley e Roy [@anderson2003; @rencher2012].
...
A formulação distingue, portanto:
...
Devem ser distinguidos, portanto:
