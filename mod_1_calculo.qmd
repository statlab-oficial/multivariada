...
As formas quadráticas foram definidas em @def-forma-quadratica, e o @prp-parte-simetrica-forma-quadratica mostrou que seu valor depende apenas da parte simétrica da matriz. O objetivo agora é obter suas derivadas.
...
O próximo capítulo inicia o **Módulo II — Fundamentos Probabilísticos e Inferenciais da Análise Multivariada** com o estudo das matrizes de covariâncias e correlações. Gradientes, formas quadráticas, transformações lineares, integrais e produtos matriciais fornecerão as ferramentas matemáticas para descrever a variabilidade conjunta de vetores aleatórios.
