...
- $\mathbf T_{\mathrm{mod}}$ representará a dispersão dos valores ajustados pelo modelo em torno da média geral;
...
Suponha que as combinações dos termos especificadas por $\mathbf C_1$ sejam estimáveis, isto é,
...
| SQPC do modelo | $\mathbf T_{\mathrm{mod}}$ | representa a dispersão dos valores ajustados em torno da média geral |
