...
Sob o particionamento na @eq-particionamento-normal,
...
Para os blocos do vetor normal multivariado na @eq-particionamento-independencia-normal,
...
Nesta subseção, a distribuição condicional será desenvolvida sob a condição
...
que garante, em particular, a invertibilidade de $\boldsymbol{\Sigma}_{22}$.
...
A segunda expressão é o complemento de Schur de $\boldsymbol{\Sigma}_{22}$ na matriz $\boldsymbol{\Sigma}$, já introduzido na @eq-complemento-schur-covariancia.
...
Utilizando a pseudoinversa espectral de @def-pseudoinversa-espectral, define-se a forma quadrática generalizada de Mahalanobis por
