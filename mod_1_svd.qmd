...
\text{núcleo}
&\longleftrightarrow
\text{vetores singulares à direita associados à parte nula},\\
\text{núcleo à esquerda}
&\longleftrightarrow
\text{vetores singulares à esquerda associados à parte nula},\\
...
Adotando temporariamente a notação
...
equivale a encontrar o ponto de $\mathcal C(\mathbf A)$ mais próximo de $\mathbf b$.

Esse ponto é a projeção ortogonal
...
essa decomposição é ortogonal. Portanto,
...
e $\widehat{\mathbf x}$ é uma solução de mínimos quadrados.

Todas as soluções produzem o mesmo vetor ajustado. Assim, se $\widehat{\mathbf x}$ é qualquer solução,
...
as duas parcelas são ortogonais. Assim,
