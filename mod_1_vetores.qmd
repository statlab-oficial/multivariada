...
::: {#exm-vetor-observado}
## Exemplo: Representação de uma observação
...
::: {#exm-observacao-r2}
## Exemplo: Observação em duas dimensões
...
::: {#exm-matriz-dados}
## Exemplo: Matriz de dados com duas variáveis
...
::: {#exm-soma-subtracao}
## Exemplo: Soma e subtração de vetores
...
## Exemplo: Combinação linear de vetores
...
## Exemplo: Combinação linear das variáveis
...
## Exemplo: Distância entre duas observações
...
::: {#exm-produto-externo}
## Exemplo: Produto externo de dois vetores
...
O resultado possui dimensão $2\times3$.
:::
