...
No MDS clássico, a relação entre distâncias euclidianas e produtos internos permite reconstruir uma matriz de Gram a partir das dissimilaridades. A decomposição espectral dessa matriz fornece as coordenadas da configuração [@torgerson1952; @gower1966].
...
A solução clássica do MDS combina a distância euclidiana definida em @def-distancia-euclidiana com a matriz de Gram de @def-matriz-gram para converter informação sobre distâncias em informação sobre produtos internos.
...
Pela propriedade de posto das matrizes de Gram estabelecida em @prp-propriedades-matriz-gram,
...
Por outro lado, @eq-coordenadas-mds-classico constrói uma configuração exatamente em
