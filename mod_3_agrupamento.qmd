...
O valor de $K$ também faz parte da especificação da solução. Os critérios de escolha do número de grupos e as estratégias computacionais de inicialização, repetição e comparação de soluções pertencem à condução aplicada da técnica e não serão desenvolvidos neste capítulo.
...
A escolha do número de grupos não é determinada automaticamente pelo dendrograma. Ela pertence à etapa de análise e validação da solução.
...
A interpretação dos grupos deve, portanto, combinar a estrutura encontrada com conhecimento sobre o problema, as variáveis utilizadas e a população estudada.
...
relaciona a homogeneidade intragrupos à separação entre os grupos.
